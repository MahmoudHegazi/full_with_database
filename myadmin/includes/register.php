...
$username = $password = $confirm_password = $usersite = $uname =  "";
$username_err = $password_err = $confirm_password_err = $website_err = $name_err = "";
	...
	*/
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($con, $sql)){
            ...
            // Set parameters
            $param_uname = test_input($_POST["thename"]);
                  
			$param_username = test_input($_POST["username"]);
			 $param_password = password_hash(test_input($password), PASSWORD_DEFAULT); // Creates a password hash     
